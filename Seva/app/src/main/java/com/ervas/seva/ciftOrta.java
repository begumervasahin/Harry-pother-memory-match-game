...
public class ciftOrta extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cift_orta);
        //müzik çalmaya başlıyor
        ply=MediaPlayer.create(ciftOrta.this,R.raw.prologue);
        ply.start();
        total();
//zamanlayıcı başlatıldı süre 60 olunca oyun bizi lobi ekranına atıcak
        ...
        new CountDownTimer(60000, 1000) {
            ...
            public void onFinish() {
                ...
                ply=MediaPlayer.create(ciftOrta.this,R.raw.basarisiz);
                ply.start();
    ...
    private void islemler(int i, final ImageButton imgb){
        if(firstResim == null){//eğer resim seçilmediyse
            ...
            if( ilkHamle == ikinihamle){//seçilen iki resim  eşit ise puan kazanırsın
                ...
                skorsay++;
                sayi1 =sayi1+40;
                play=MediaPlayer.create(ciftOrta.this,R.raw.happy);
                play.start();
                puan1.setText("oyuncu1:: " + sayi1 );
                puan2.setText("oyuncu2:: " + sayi2);
                if(skorsay == imagenes.length){
                    play=MediaPlayer.create(ciftOrta.this,R.raw.alkis);
                    play.start();
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        bloqueo = false;
                        firstResim = null;
                        play= MediaPlayer.create(ciftOrta.this,R.raw.basarisiz);
                        play.start();
