...
public class Kolay extends AppCompatActivity {
    ...
    int a;
    ImageButton imb00, imb01, imb02, imb03, imb04;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ply=MediaPlayer.create(Kolay.this,R.raw.prologue);
        ply.start();
        total();
        ...
        new CountDownTimer(45000, 1000) {
            ...
            public void onFinish() {
                play=MediaPlayer.create(Kolay.this,R.raw.basarisiz);
                play.start();
    ...
    private void islemler(int i, final ImageButton imgb){
        if(ilk == null){//eğer kart seçilmemişse
            ...
            if(ilkHamle == ikinciHamle){//doğru resimler seçilmiş ise
                ...
                hamlesayac++;
                puan1=puan1+20;
                play=MediaPlayer.create(Kolay.this,R.raw.happy);
                play.start();
                puan.setText("skor " + puan1);
                if(hamlesayac == imagenes.length){//tüm kartlar doğru eşleşmiş ise
                    play=MediaPlayer.create(Kolay.this,R.raw.alkis);
                    play.start();
